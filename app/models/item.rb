...
validates :price        , presence: true, presence: { message: "can't be blank" },
                                          numericality: { greater_than_or_equal_to: 300, less_than_or_equal_to: 9999999, message: "must be a number between 300 and 9999999" }, 
                                          format: { with: /\A[0-9]+\z/ }
